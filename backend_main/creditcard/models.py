...
class CreditCard(models.Model):
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['user', 'is_default'], name='unique_default_card')
        ]
    ...
    expiration_date = models.CharField(max_length=5,  help_text="format: MM/YY",verbose_name="expiration date")
    cvv = EncryptedCharField(max_length=3)
    name = models.CharField(max_length=100, verbose_name="name on card", blank=True, null=True)
